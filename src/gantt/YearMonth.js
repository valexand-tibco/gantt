...
export default function YearMonth({
  styles, dates, unit, offsetY, minTime, maxTime, maxTextWidth, dataHeight, width
}) {
  ...
  return (
    <g>
      ...
      <line x1={width} x2={width} y1={offsetY / 2} y2={y2} style={styles.line} />
    </g>
  );
}
